...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Generate deterministic Chinese SAM2 object and speech descriptions."
    )
    ...
    result = {
        ...
        "description_dir": str(output_dir / "descriptions" / "frames"),
        "speech_summary_path": str(output_dir / "speech_summary.json"),
        "text_summary_path": str(output_dir / "summary.txt"),
    }
